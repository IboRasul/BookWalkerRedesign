<div class="contact-form-container">
  ...
  <div class="contact-form">
    <form action="contactus.php" method="get">
      ...
      <textarea placeholder="Tell us about your project..." name="text" rows="4"></textarea>
      <button type="submit" name="submit">SEND </button>
      <?php if (isset($_GET['submit'])) {
        echo "Mail has been set";
        mail("iborasul@gmail.com","TESTING MAILING" , $_GET['text']);
}?>
    </form>
  </div>
</div>

<button><a href="../index.php" style="text-decoration: none; color: black; font-size:large;"  >GO HOME</a></button>
<style>
